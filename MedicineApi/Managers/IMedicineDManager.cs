...
{
    public interface IMedicineDkManager : IGetMedication<List<GetMedicineDTO>>, ISearchMedication<List<SearchMedicineDTO>>, IGetMedicationWithId<GetMedicineWithId>
    {
